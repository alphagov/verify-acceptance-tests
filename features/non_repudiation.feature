Feature: User registers, returns to confirm identity and signs in successfully
  ...
  Scenario: User registers, confirms identity and signs in
    ...
    And they continue to register with IDP "Stub Idp Two"
    ...
    Then they arrive at the confirm identity page for "Stub Idp Two"
    When they click "Sign in with Stub Idp Two"
